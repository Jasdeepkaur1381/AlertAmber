...
$sql = "INSERT INTO orders (name , email ,date, time,peto) values ('$name','$email', '$date' ,'$time','$peto')";
if ($conn->query($sql))
{
    ?>
...
<body>
    <div
        class="w-1/2 m-auto h-58 border-4 shadow-3xl rounded-b-xl  ring ring-grey-600 ring-offset-4 ring-offset-grey-100 flex flex-col p-10">
        <h1 class="text-center text-4xl text-primary">Order is placed successfully</h1>
        <h3 class="text-center text-2xl text-primary">We will get back to you with 24 hours</h3>
