...
$sql = "INSERT INTO queryform (Name , Email , Subject , Message) values ('$name','$email', '$subject' ,'$message')";
if ($conn->query($sql))
{
...
<body>
    <div
        ...
        <h1 class="text-center text-4xl text-primary">Your query is saved</h1>
